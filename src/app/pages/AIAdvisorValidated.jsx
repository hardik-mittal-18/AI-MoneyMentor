...
function AIAdvisorValidated() {
  ...
  async function handleSubmit(e) {
    ...
    setError(null);
    setResult(null);
    if (!canAccessFeature("ai_advisor_validated", plan)) {
      setUpgradeOpen(true);
      return;
    }
  ...
  return <div className="space-y-8">
      ...
      {result ? <div className="grid gap-4 lg:grid-cols-12 animate-in fade-in-0 duration-300">
          <div className="lg:col-span-8">
            <Card className="rounded-2xl">
              ...
              <CardContent className="space-y-3">
                ...
                {result.warning ? <Alert variant="destructive">
                ...
                <Card className="rounded-2xl">
                  ...
                  <CardContent>
                    <Table>
                      ...
                      <TableBody>
                        {(result.daily_sip_plan.length ? result.daily_sip_plan : []).map((p) => <TableRow key={p.plan}>
