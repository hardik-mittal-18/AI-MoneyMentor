...
import { TrendingUp, ArrowRight, Mail, Lock, User } from "lucide-react";
  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
          ...
          {error && <div className="mb-5 rounded-xl border border-red-100 bg-red-50 px-4 py-3">
